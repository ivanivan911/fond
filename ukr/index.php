        ...
        <!--Modal window-->
            ...
            <div id="modal_form">
                ...
                <div class="modal-field-wrapper">
                    <input type="text" class="modal_form_input modal_name" placeholder="Ім'я *">
                    <span class="modal-error modal-name-error"></span>
                </div>
                <div class="modal-field-wrapper">
                    <input type="email" class="modal_form_input modal_email" placeholder="Email *">
                    <span class="modal-error modal-email-error"></span>
                </div>
                <div class="modal-field-wrapper">
                    <input type="text" class="modal_form_input modal_phone" placeholder="Номер телефону">
                    <span class="modal-error modal-phone-error"></span>
                </div>
                <div class="modal-field-wrapper">
                    <textarea cols="30" rows="10" class="modal_form_input modal_message" placeholder="Текст повідомлення *"></textarea>
                    <span class="modal-error modal-message-error"></span>
                </div>
